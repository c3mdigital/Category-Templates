=== Category Templates ===
Contributors: aarongloege, Chris Olbekson
Tags: category, template, post
Requires at least: 3.1
Tested up to: 3.2.1
Stable tag: 3.0

This is a fork of Arron Loege's Category Template plugin to fix some minor bugs and compatibility issues with WordPress 3.0 +
